---
layout: default
title: HighGamma dataset
parent: Preprocessing
nav_order: 2
---

# mixnet.preprocessing.HighGamma

[<img src="https://mixnetbci.github.io/assets/images/github.png" width="30" height="30"> View source on GitHub](https://github.com/Max-Phairot-A/MixNet/blob/main/mixnet/preprocessing/HighGamma){: .btn .fs-5 .mb-4 .mb-md-0 } 
...
[<img src="https://mixnetbci.github.io/assets/images/github.png" width="30" height="30"> View source on GitHub](https://github.com/Max-Phairot-A/MixNet/blob/main/mixnet/preprocessing/HighGamma/time_domain.py){: .btn .fs-5 .mb-4 .mb-md-0 } 
...
prep.HighGamma.time_domain.subject_dependent_setting(k_folds=5,
                                                 pick_smp_freq=100, 
                                                 bands=[8, 30], 
                                                 order=5, 
                                                 save_path='datasets')
...
prep.HighGamma.time_domain.subject_independent_setting(k_folds=5,
                                                    pick_smp_freq=100, 
                                                    bands=[8, 30], 
                                                    order=5, 
                                                    save_path='datasets')
...
[<img src="https://mixnetbci.github.io/assets/images/github.png" width="30" height="30"> View source on GitHub](https://github.com/Max-Phairot-A/MixNet/blob/main/mixnet/preprocessing/HighGamma/fbcsp.py){: .btn .fs-5 .mb-4 .mb-md-0 } 
...
prep.HighGamma.fbcsp.subject_dependent_setting(k_folds=5, 
                                            pick_smp_freq=100, 
                                            n_components=4, 
                                            bands=bands, 
                                            n_features=8, 
...
prep.HighGamma.fbcsp.subject_independent_setting(k_folds=5, 
                                              pick_smp_freq=100, 
                                              n_components=4, 
                                              bands=bands, 
                                              n_features=8, 
...
[<img src="https://mixnetbci.github.io/assets/images/github.png" width="30" height="30"> View source on GitHub](https://github.com/Max-Phairot-A/MixNet/blob/main/mixnet/preprocessing/HighGamma/spectral_spatial.py){: .btn .fs-5 .mb-4 .mb-md-0 } 
...
prep.HighGamma.spectral_spatial.subject_dependent_setting(k_folds=5, 
                                                       pick_smp_freq=100, 
                                                       n_components=10, 
                                                       bands=bands, 
                                                       n_pick_bands=20, 
...
prep.HighGamma.spectral_spatial.subject_independent_setting(k_folds=5, 
                                                         pick_smp_freq=100, 
                                                         n_components=10, 
                                                         bands=bands, 
                                                         n_pick_bands=20, 
...
[<img src="https://mixnetbci.github.io/assets/images/github.png" width="30" height="30"> View source on GitHub](https://github.com/Max-Phairot-A/MixNet/blob/main/mixnet/preprocessing/HighGamma/spectral_spatial_signals.py){: .btn .fs-5 .mb-4 .mb-md-0 } 
...
prep.HighGamma.spectral_spatial_signals.subject_dependent_setting(k_folds=5, 
                                                       pick_smp_freq=100, 
                                                       n_components=6, 
                                                       bands=bands, 
                                                       order=5,
...
prep.HighGamma.spectral_spatial_signals.subject_independent_setting(k_folds=5, 
                                                         pick_smp_freq=100, 
                                                         n_components=10, 
                                                         bands=bands, 
                                                         order=5, 
