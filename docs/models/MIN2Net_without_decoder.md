...
| loss         | `list` of `str` (name of objective function), objective function or [tf.keras.losses.Loss](https://www.tensorflow.org/api_docs/python/tf/keras/losses) instance.  | [[`triplet_loss(margin=1.0)`](https://github.com/IoBT-VISTEC/MIN2Net/blob/main/min2net/loss.py#L17), <br/> `'sparse_categorical_crossentropy'`]  |
